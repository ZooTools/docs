...
1. Create a new transactional email on your [zootools dashboard](https://app.zootools.co).

Use a friendly `name`, so both you and the marketer can understand what's the email is about.

![Alt Text](https://github.com/ZooTools/docs/blob/main/images/messages/create-transactional.png?raw=true)

2. View your transactional message and instructions based on your programming language

![Alt Text](https://github.com/ZooTools/docs/blob/main/images/messages/view-transactional.png?raw=true)
...
![Alt Text](https://github.com/ZooTools/docs/blob/main/images/messages/edit-template.png?raw=true)
